...
// Class 1 pre-trip in Valley Driving School order — the full 42-step sequence, typically done in under 45 min.
// Indices in titles mirror the Valley sheet. Items flagged ab:true are air-brake checks; phases with allAb:true are entirely air-brake.
const PRETRIP = [
  {id:"start", t:"Start — block & secure", icon:"prep", note:"Steps 1–3. Block the wheels first so the spring brakes can release safely. Valley target: the whole pre-trip in under 45 minutes.", items:[
    {t:"1 · Block wheels", d:"Chock in front of and behind a tire on the same axle — the vehicle must not move when spring brakes release."},
    {t:"Emergency equipment", d:"Charged fire extinguisher, first aid kit, and safety triangles."},
    {t:"2 · ADIS", d:"Explain ADIS (automatic drain). Drain the wet tank if the truck has one.", ab:true},
    {t:"3 · Hood", d:"Open the hood."},
  ]},
  {id:"hood", t:"Under hood — driver & passenger side", icon:"hood", note:"Steps 4–10. Done on both sides (4&7, 5&8, 6&9), then secure the hood.", items:[
    {t:"4 & 7 · Fluids and levels", d:"Coolant, engine oil, clutch, washer and steering fluid — adequate level, no leaks."},
    {t:"Engine", d:"Hoses and clamps secure; no cracks or bulges."},
    {t:"Compressor and air lines", d:"No cracks or leaks.", ab:true},
    {t:"5 & 8 · Belts", d:"Check tension and wear — adequate tension, no cracks."},
    {t:"Steering components / tie rod", d:"Secure, with no bends or cracks."},
    {t:"6 & 9 · Front brake / wheel & axle", d:"Air line, brake chamber, brake pushrod travel (½–¾ in / 12–20 mm), rim, sidewall, tread (min 3 mm), inflation, lug nuts, hub oil. If disc brakes, explain there is no pushrod travel.", ab:true},
    {t:"10 · Hood", d:"Close and secure."},
    {t:"Wet tank", d:"If no ADIS — close and secure the tank; air lines have no bulges or cracks.", ab:true},
  ]},
  {id:"cab", t:"In-cab check", icon:"cab", note:"Steps 11–12. Key on, start the engine in neutral with the clutch down, then work through the cab.", items:[
    {t:"11 · Key to ‘on’", d:"Check the warning lights are working, then start the engine."},
    {t:"If no ADIS", d:"Confirm the one-way check valves are working (air pressure still up).", ab:true},
    {t:"Start engine", d:"In neutral, clutch halfway down. Release the spring brakes."},
    {t:"Check gauges", d:"Oil pressure, temperature, fuel and charging system working, with adequate levels."},
    {t:"12 · Seat and seatbelt", d:"Driver and passenger — secure, adjusted, no frays."},
    {t:"Dash lights and accessories", d:"Turn on lights, hazards, horn, wipers and washer fluid, defroster — confirm working."},
    {t:"Glass and mirrors", d:"Adjust all mirrors; windows and windshield clean, no cracks; driver window opens and closes."},
  ]},
  {id:"abair", t:"In-cab air system & trailer breakaway", icon:"brake", note:"Steps 13–15. Watch the gauge against the air-brake numbers above.", allAb:true, items:[
    {t:"13 · Governor unloads compressor", d:"Needles stop climbing; steady pressure 105–135 psi."},
    {t:"Fan brakes down", d:"Fan the pressure down ~20 psi, going no lower than 80 psi."},
    {t:"Governor reloads compressor", d:"Air pressure starts climbing again."},
    {t:"Low-air warning", d:"Fan the brakes until the warning devices come on — 60 psi or above."},
    {t:"Fan to trailer breakaway", d:"Keep fanning until the trailer spring brakes dynamite (apply) — 45–20 psi."},
    {t:"14 · Shut off engine", d:"Confirm the spring brakes dynamited (applied) on the trailer."},
    {t:"Remove glad hands", d:"Disconnect — no leaks."},
    {t:"Foot brake", d:"Apply ~5 sec — tractor protection valve working; listen for leaks."},
    {t:"Reconnect glad hands", d:"Check the air lines and electrical cord."},
    {t:"15 · Start engine", d:"Set RPM between 1,000 and 1,200."},
    {t:"Build-up time", d:"Building 50 → 90 psi must take less than 3 minutes."},
    {t:"Release spring brakes", d:"Push the tractor and trailer buttons in."},
    {t:"Governor unloads compressor", d:"Build air until the governor unloads the compressor (105–135 psi)."},
  ]},
  {id:"leak", t:"16 · Applied leakage test", icon:"test", note:"Engine off, full application, hold one minute.", allAb:true, items:[
    {t:"Shut off engine", d:"Ignition to the ‘on’ position if electric gauges."},
    {t:"Full brake application", d:"Ensure psi over 90, then hold for 1 minute. Start timing after the gauges settle."},
    {t:"Confirm air loss", d:"No more than 4 psi within 1 minute."},
  ]},
  {id:"front", t:"Lights & front of tractor", icon:"light", note:"Steps 17–18. Begin the exterior circle check at the front.", items:[
    {t:"17 · Turn on lights", d:"Headlights and left signal on, then check them."},
    {t:"18 · Front of tractor", d:"Bumper, grille, licence plate secure and valid."},
    {t:"Lenses", d:"Signal, marker and headlights working."},
  ]},
  {id:"dtractor", t:"Driver-side tractor & drive axles", icon:"truck", note:"Steps 19–21. Down the driver side, then under the drive axles.", items:[
    {t:"19 · Mirrors & lights", d:"Mirrors secure, checked inside; additional lights working."},
    {t:"Batteries", d:"Checked weekly for corrosion and leaks."},
    {t:"Driver door / steps / handrail", d:"Secure, door works."},
    {t:"Fuel and DEF caps", d:"Securely fastened, no leaks."},
    {t:"Exhaust system (pipe and muffler)", d:"Secure, no cracks."},
    {t:"20 · Axle #2 — under vehicle", d:"Drive shaft has minimal play; frame not cracked; air bags inflated; differential not leaking; air tanks and lines secure, no cracks or bulges; brake chambers secure; pushrod travel ½–¾ in.", ab:true},
    {t:"21 · Axle #3 — under vehicle", d:"Short drive shaft has minimal play; air bags inflated; rear differential not leaking; air lines secure, no cracks or bulges; brake chambers secure; pushrod travel ½–¾ in.", ab:true},
  ]},
  {id:"reartractor", t:"Rear of tractor / fifth wheel", icon:"hitch", note:"Steps 22–23. Confirm the coupling before moving down the trailer.", items:[
    {t:"22 · Fifth wheel", d:"Locking jaws are closed. Licence plate secure, valid, light working. Lights working: left signal, right park."},
    {t:"Landing gear & cross members", d:"Bolt or pin not cracked, fully raised; trailer cross members secure, no cracks or bends."},
    {t:"23 · Frame and fifth wheel", d:"No daylight between the plate and the bottom of the trailer apron."},
  ]},
  {id:"dtrailer", t:"Driver-side trailer & axles", icon:"trailer", note:"Steps 24–28. Tires, body, both trailer axles, then the slider.", items:[
    {t:"24 · Tires / wheels / mud flap", d:"Rims not cracked or dented; sidewalls not cracked, cut or bulged; tire pressure adequate; lug nuts not missing or loose; no rust streaks; tread even, min 1.5 mm; duals clear; mud flap secure, not rubbing or dragging."},
    {t:"25 · Trailer body", d:"No new damage or dents; reflective tape installed."},
    {t:"26 · Axle #4 air brakes", d:"Air tank secure, no leaks; air bags inflated; air lines no cracks or bulges; brake chamber secure; slack adjuster pushrod travel ½–¾ in.", ab:true},
    {t:"27 · Axle #5 air brakes", d:"Air tank secure, no leaks; air bags inflated; air lines no cracks or bulges; brake chamber secure; slack adjuster pushrod travel ½–¾ in.", ab:true},
    {t:"28 · Slider assembly / frame", d:"No cracks or defects; pins secure and locked."},
    {t:"Tires / wheels / mud flap", d:"Rims not cracked or dented; sidewalls sound; pressure adequate; lug nuts present; no rust streaks; tread even, min 1.5 mm; duals clear; mud flap secure; hub oil level full (if visible), no leaks."},
  ]},
  {id:"reartrailer", t:"Rear of trailer & brake lights", icon:"light", note:"Steps 29–30. Inspect the load, then check brake and signal lights.", items:[
    {t:"29 · Reflective tape & load", d:"Reflective tape installed. Open both doors to inspect the load, then close and secure the doors."},
    {t:"Lights & plate", d:"Clearance, left signal, tail lights and licence-plate light working. Licence plate secure with valid sticker."},
    {t:"30 · Brakes", d:"Apply the foot brake — ask the ICBC examiner to confirm the brake lights are working.", ab:true},
    {t:"Apply spring brakes", d:"Pull out the tractor (yellow) and trailer (red) spring-brake buttons.", ab:true},
    {t:"Turn on and check lights", d:"Right signal and high beams."},
  ]},
  {id:"ptrailer", t:"Passenger side & wheel blocks", icon:"trailer", note:"Steps 32–36. Back up the passenger side, then pull the blocks. (The Valley sheet skips index 31.)", items:[
    {t:"32 · Trailer body", d:"No new damage; reflective tape installed."},
    {t:"33 · Slider assembly / frame", d:"No cracks or defects; pins secure and locked."},
    {t:"Rear trailer tires / wheels / mud flap", d:"Rims not cracked or dented; sidewalls sound; pressure adequate; lug nuts present; no rust streaks; tread even, min 1.5 mm; duals clear; mud flap secure; hub oil level full (if visible), no leaks."},
    {t:"34 · Inspection decal & lights", d:"Trailer vehicle inspection decal secure and valid; tractor right signal working."},
    {t:"Frame and fifth wheel", d:"No daylight between the plate and the bottom of the trailer apron."},
    {t:"Tractor tires / wheels / mud flap", d:"Rims not cracked or dented; sidewalls sound; pressure adequate; lug nuts present; no rust streaks; tread even, min 1.5 mm; duals clear; mud flap secure; hub oil full (if visible), no leaks."},
    {t:"35 · Exhaust & fuel", d:"Exhaust system (pipe and muffler) secure, no cracks; fuel cap securely fastened, no leaks."},
    {t:"Tractor decal & door", d:"Tractor vehicle inspection decal secure and valid; passenger door / steps / handrail secure, door works."},
    {t:"Mirrors & lenses", d:"Mirrors secure; lenses — signal, marker, headlights."},
    {t:"36 · Remove wheel blocks", d:"Confirm the spring brakes are applied, then remove the blocks."},
  ]},
  {id:"response", t:"Brake response test (in cab)", icon:"brake", note:"Steps 37–42. Final in-cab checks before you hand in the report.", allAb:true, items:[
    {t:"37 · Start engine", d:"In neutral, clutch halfway down."},
    {t:"38 · Trailer tug test", d:"Yellow button in, red button out, truck in first gear; gently release the clutch until resistance is felt — it must not move."},
    {t:"39 · Tractor tug test", d:"Red button in, yellow button out, truck in first gear; gently release the clutch until resistance is felt — it must not move."},
    {t:"40 · Trailer brake response", d:"Release both spring brakes, shift to first, gently release the clutch and apply the trailer hand-valve brake."},
    {t:"41 · Tractor brake response", d:"Release both spring brakes, shift to first, gently release the clutch and apply the tractor foot brake."},
    {t:"42 · Trip inspection report", d:"Complete it and give it to the ICBC examiner."},
  ]},
];
