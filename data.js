...
const PRETRIP = [
  {id:"prep", t:"Before you begin", icon:"prep", note:"Set up so the vehicle can't move while spring brakes are released.", items:[
    ...
    {t:"Gather equipment", d:"Flashlight, tire pressure gauge, chalk/marker, ruler, pry bar, wrench, timing device. Sturdy clothing, eye protection."},
  ...
  {id:"hood", t:"1 · Under hood", icon:"hood", note:"As you approach, look underneath for leaks. Drain reservoirs (road test: supply reservoir only).", items:[
    ...
    {t:"Foundation brakes", d:"Chambers & clamps secure, no cracks/leaks; pushrod travel within tolerance; slack adjuster, s-cam, bushings; air lines; drums not cracked; linings not contaminated, thickness OK.", ab:true},
  ...
  {id:"cab", t:"2 · In cab", icon:"cab", note:"Ignition ON, then start the engine and check while air builds.", items:[
    ...
    {t:"Emergency equipment", d:"Warning devices/flares present; fire extinguisher date valid."},
  ...
  {id:"mech", t:"5 · Mechanical circle check", icon:"circle", note:"Left tractor → fifth wheel → left trailer → rear → right trailer → underside → right tractor.", items:[
    {t:"Left side of tractor", d:"Mirrors, steps & handrails, fuel tanks/caps/lines, exhaust, batteries (secure, no corrosion/leaks), storage compartments, body."},
    {t:"Fifth wheel connection", d:"Plate flush to trailer apron — NO daylight; slider locked & secure with room to turn; locking jaws closed around the kingpin.", ab:false},
    ...
    {t:"Right side of tractor", d:"Mirrors, steps, fuel tanks, exhaust, batteries, storage, body + CVIP decal, frame, fifth wheel, suspension, drive wheels."},
  ]},
