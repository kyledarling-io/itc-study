...
// Class 1 tractor-trailer pre-trip + air-brake check, in walk-around order (Valley Driving School sequence).
// Each item is ONE check — the renderer numbers them sequentially, so the order is the single source of truth.
// it.ab = air-brake check (gets the AIR tag); phase.allAb = the whole phase is air-brake; it.grp = sub-station heading.
const PRETRIP = [
  {id:"start", t:"Block & secure", icon:"prep", note:"Set up before anything moves — block the wheels first so the spring brakes can release safely.", items:[
    {t:"Block the wheels", d:"Chock in front of and behind a tire on the same axle — the vehicle must not move when the spring brakes release."},
    {t:"Emergency equipment", d:"Charged fire extinguisher, first-aid kit and safety triangles on board."},
    {t:"Air dryer / wet tank", d:"Explain the automatic drain (ADIS). Drain the wet tank manually if the truck has one.", ab:true},
    {t:"Open the hood", d:"Release and raise the hood to begin the engine-compartment checks."},
  ]},
  {id:"hood", t:"Under the hood", icon:"hood", note:"Engine-compartment checks — perform each one on both the driver and passenger sides, then close the hood.", items:[
    {t:"Fluids & levels", d:"Coolant, engine oil, clutch, washer and power-steering fluid — adequate level, no leaks."},
    {t:"Engine hoses & clamps", d:"Secure, with no cracks or bulges."},
    {t:"Air compressor & lines", d:"No cracks or leaks.", ab:true},
    {t:"Belts", d:"Adequate tension, no cracks or fraying."},
    {t:"Steering linkage & tie rods", d:"Secure, with no bends or cracks."},
    {t:"Front wheel & tire", d:"Rim, sidewall, tread (min 3 mm), inflation, lug nuts and hub oil all good."},
    {t:"Front brakes", d:"Air line and brake chamber secure; pushrod travel ½–¾ in (12–20 mm). If disc brakes, explain there is no pushrod travel.", ab:true},
    {t:"Close the hood", d:"Lower and secure the hood."},
    {t:"Wet tank (if no ADIS)", d:"Close and secure the tank; air lines have no bulges or cracks.", ab:true},
  ]},
  {id:"cab", t:"In the cab", icon:"cab", note:"Key on, then start the engine in neutral with the clutch down and work through the cab controls.", items:[
    {t:"Key to ‘on’", d:"Warning lights illuminate and work, then start the engine."},
    {t:"Check valves (if no ADIS)", d:"Confirm the one-way check valves hold — air pressure stays up.", ab:true},
    {t:"Start the engine", d:"In neutral, clutch halfway down; release the spring brakes."},
    {t:"Gauges", d:"Oil pressure, temperature, fuel and charging system all working with adequate readings."},
    {t:"Seat & seatbelt", d:"Driver and passenger — secure, adjusted, no frays."},
    {t:"Lights & accessories", d:"Headlights, hazards, horn, wipers, washer fluid and defroster all work."},
    {t:"Mirrors", d:"Adjust all mirrors; secure and clean."},
    {t:"Windows & windshield", d:"Clean, no cracks; driver window opens and closes."},
  ]},
  {id:"abair", t:"Air system & trailer breakaway", icon:"brake", note:"Run the in-cab air-brake sequence — watch the gauge against the air-brake numbers above.", allAb:true, items:[
    {t:"Governor cut-out", d:"Needles stop climbing; pressure holds at 105–135 psi."},
    {t:"Fan down ~20 psi", d:"Fan the pressure down about 20 psi, no lower than 80 psi."},
    {t:"Governor cut-in", d:"Pressure starts climbing again."},
    {t:"Low-air warning", d:"Keep fanning until the warning device comes on — at or above 60 psi."},
    {t:"Trailer breakaway", d:"Keep fanning until the trailer spring brakes apply (dynamite) — 45–20 psi."},
    {t:"Shut off the engine", d:"Confirm the trailer spring brakes applied."},
    {t:"Remove the glad hands", d:"Disconnect — no leaks."},
    {t:"Foot brake / tractor protection", d:"Apply ~5 sec; the tractor protection valve works; listen for leaks."},
    {t:"Reconnect the glad hands", d:"Reconnect and check the air lines and electrical cord."},
    {t:"Restart & set RPM", d:"Start the engine and set 1,000–1,200 rpm."},
    {t:"Build-up time", d:"Building 50 → 90 psi must take less than 3 minutes."},
    {t:"Release the spring brakes", d:"Push the tractor and trailer buttons in."},
    {t:"Build to cut-out", d:"Build air until the governor cuts out (105–135 psi)."},
  ]},
  {id:"leak", t:"Applied leakage test", icon:"test", note:"Engine off, full application, hold for one minute.", allAb:true, items:[
    {t:"Engine off", d:"Ignition to the ‘on’ position if the gauges are electric."},
    {t:"Full application", d:"Pressure over 90 psi, then hold the brakes for 1 minute — start timing once the gauges settle."},
    {t:"Confirm air loss", d:"No more than 4 psi lost in that minute (single trailer)."},
  ]},
  {id:"front", t:"Front of the tractor", icon:"light", note:"Start the exterior walk-around at the front, lights on.", items:[
    {t:"Headlights & left signal", d:"Turn them on, then check them as you walk."},
    {t:"Bumper, grille & plate", d:"Secure; licence plate present and valid."},
    {t:"Front lenses", d:"Signal, marker and headlights working, lenses intact."},
  ]},
  {id:"dtractor", t:"Driver side — tractor", icon:"truck", note:"Down the driver side of the tractor, then under the drive axles.", items:[
    {t:"Mirrors", d:"Secure; checked from inside."},
    {t:"Cab lights & lenses", d:"Additional lights and lenses working."},
    {t:"Batteries", d:"Checked weekly for corrosion and leaks."},
    {t:"Door, steps & handrail", d:"Secure; door works."},
    {t:"Fuel & DEF caps", d:"Securely fastened, no leaks."},
    {t:"Exhaust system", d:"Pipe and muffler secure, no cracks."},
    {t:"Drive shaft & frame", d:"Drive shaft has minimal play; frame not cracked.", grp:"Drive axle #2"},
    {t:"Air bags & differential", d:"Air bags inflated; differential not leaking.", grp:"Drive axle #2"},
    {t:"Air tanks, lines & brakes", d:"Tanks and lines secure, no cracks or bulges; brake chambers secure; pushrod travel ½–¾ in.", ab:true, grp:"Drive axle #2"},
    {t:"Drive shaft & frame", d:"Short drive shaft has minimal play; frame sound.", grp:"Drive axle #3"},
    {t:"Air bags & differential", d:"Air bags inflated; rear differential not leaking.", grp:"Drive axle #3"},
    {t:"Air tanks, lines & brakes", d:"Lines secure, no cracks or bulges; brake chambers secure; pushrod travel ½–¾ in.", ab:true, grp:"Drive axle #3"},
  ]},
  {id:"reartractor", t:"Rear of tractor / fifth wheel", icon:"hitch", note:"Confirm the coupling before moving down the trailer.", items:[
    {t:"Fifth wheel coupling", d:"Locking jaws fully closed and locked around the kingpin."},
    {t:"No daylight at the apron", d:"No gap between the fifth-wheel plate and the bottom of the trailer apron."},
    {t:"Landing gear", d:"Fully raised; pin or bolt not cracked."},
    {t:"Cross members", d:"Trailer cross members secure, no cracks or bends."},
    {t:"Licence plate", d:"Secure, valid, plate light working."},
    {t:"Rear tractor lights", d:"Left signal and right park lights working."},
  ]},
  {id:"dtrailer", t:"Driver side — trailer", icon:"trailer", note:"Down the driver side of the trailer: body, both axles, then the slider.", items:[
    {t:"Trailer body", d:"No new damage or dents."},
    {t:"Reflective tape", d:"Conspicuity tape present and intact."},
    {t:"Wheels & tires", d:"Rim, sidewall, pressure, lug nuts (no rust streaks), tread min 1.5 mm, duals clear, mud flap secure.", grp:"Trailer axle #4"},
    {t:"Air brakes", d:"Air tank secure, no leaks; air bags inflated; lines sound; brake chamber secure; pushrod travel ½–¾ in.", ab:true, grp:"Trailer axle #4"},
    {t:"Wheels & tires", d:"Rim, sidewall, pressure, lug nuts (no rust streaks), tread min 1.5 mm, duals clear, mud flap secure; hub oil full (if visible), no leaks.", grp:"Trailer axle #5"},
    {t:"Air brakes", d:"Air tank secure, no leaks; air bags inflated; lines sound; brake chamber secure; pushrod travel ½–¾ in.", ab:true, grp:"Trailer axle #5"},
    {t:"Slider assembly & frame", d:"No cracks or defects; locking pins secure and engaged."},
  ]},
  {id:"reartrailer", t:"Rear of trailer", icon:"light", note:"Inspect the load, then check the brake and signal lights from behind.", items:[
    {t:"Reflective tape", d:"Conspicuity tape present and intact across the rear."},
    {t:"Cargo doors & load", d:"Open both doors to inspect the load, then close and secure them."},
    {t:"Rear lights", d:"Clearance, left signal, tail lights and plate light working."},
    {t:"Licence plate", d:"Secure, with a valid sticker."},
    {t:"Brake lights", d:"Apply the foot brake — ask the ICBC examiner to confirm the brake lights work.", ab:true},
    {t:"Apply spring brakes", d:"Pull out the tractor (yellow) and trailer (red) spring-brake buttons.", ab:true},
    {t:"Right signal & high beams", d:"Turn on and check the right signal and high beams."},
  ]},
  {id:"ptrailer", t:"Passenger side", icon:"trailer", note:"Back up the passenger side — trailer first, then the tractor — and finish by pulling the blocks.", items:[
    {t:"Trailer body", d:"No new damage; reflective tape installed.", grp:"Trailer"},
    {t:"Slider assembly & frame", d:"No cracks or defects; pins secure and locked.", grp:"Trailer"},
    {t:"Wheels & tires", d:"Rim, sidewall, pressure, lug nuts (no rust streaks), tread min 1.5 mm, duals clear, mud flap secure; hub oil full (if visible), no leaks.", grp:"Trailer"},
    {t:"Inspection decal", d:"Trailer vehicle-inspection decal secure and valid.", grp:"Trailer"},
    {t:"No daylight at the apron", d:"No gap between the fifth-wheel plate and the bottom of the trailer apron.", grp:"Coupling"},
    {t:"Wheels & tires", d:"Rim, sidewall, pressure, lug nuts (no rust streaks), tread min 1.5 mm, duals clear, mud flap secure; hub oil full (if visible), no leaks.", grp:"Tractor"},
    {t:"Exhaust system", d:"Pipe and muffler secure, no cracks.", grp:"Tractor"},
    {t:"Fuel cap", d:"Securely fastened, no leaks.", grp:"Tractor"},
    {t:"Inspection decal", d:"Tractor vehicle-inspection decal secure and valid.", grp:"Tractor"},
    {t:"Door, steps & handrail", d:"Passenger door, steps and handrail secure; door works.", grp:"Tractor"},
    {t:"Mirrors", d:"Secure.", grp:"Tractor"},
    {t:"Lenses", d:"Signal, marker and headlights.", grp:"Tractor"},
    {t:"Right signal", d:"Tractor right signal working.", grp:"Tractor"},
    {t:"Remove wheel blocks", d:"Confirm the spring brakes are applied, then remove the chocks.", grp:"Finish"},
  ]},
  {id:"response", t:"Brake response test", icon:"brake", note:"Final in-cab checks before you hand in the report.", allAb:true, items:[
    {t:"Start the engine", d:"In neutral, clutch halfway down."},
    {t:"Trailer tug test", d:"Yellow button in, red button out, truck in first gear; gently release the clutch until resistance is felt — it must not move."},
    {t:"Tractor tug test", d:"Red button in, yellow button out, truck in first gear; gently release the clutch until resistance is felt — it must not move."},
    {t:"Trailer brake response", d:"Release both spring brakes, shift to first, gently release the clutch and apply the trailer hand valve."},
    {t:"Tractor brake response", d:"Release both spring brakes, shift to first, gently release the clutch and apply the tractor foot brake."},
    {t:"Trip inspection report", d:"Complete it and hand it to the ICBC examiner."},
  ]},
];
